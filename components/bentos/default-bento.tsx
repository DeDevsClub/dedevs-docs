...
const items: GridItem[] = [
    ...
    { 
      ...
      icon: <Icon icon="mdi:school" className="w-6 h-6 text-[#2470FF]" />,
...
const DefaultBento = () => {
    ...
    <div className="items-center justify-between max-w-screen mx-auto p-2">
      ...
      <div className="mx-auto flex flex-wrap w-full gap-2 mt-2 text-white items-center justify-center  no-underline">
