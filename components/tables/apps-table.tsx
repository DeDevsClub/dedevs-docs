    ...
    cell: ({ row, table }) => {
      ...
      return (
        <div className="font-medium justify-end items-center flex w-full">
          <div className="flex items-center gap-2 truncate mr-2" title={displayUrl}>
            {displayUrl}
          </div>
...
export function AppsTable() {
  ...
  const data: Dapp[] = dappsData; // Use the renamed import
  ...
  const table = useReactTable({
    ...
    meta: { // Pass methods and state to table instance
      handleCopyUrl,
      copiedUrl,
