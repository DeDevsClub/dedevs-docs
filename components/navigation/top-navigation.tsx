  ...
  menu = [
    {
      ...
      items: [
        ...
        },
        {
          title: "Products",
          icon: (
            <Icon icon="lets-icons:book-duotone" className="size-5 shrink-0" />
          ),
          url: "/docs/learn/concepts",
        },
        {
          title: "Contracts",
          icon: (
            <Icon icon="ant-design:code-twotone" className="size-5 shrink-0" />
          ),
          url: "/docs/build/concepts",
        },
        {
          title: "Data",
          icon: (
            <Icon icon="ic:twotone-area-chart" className="size-5 shrink-0" />
          ),
          url: "/docs/analyze/concepts",
        },
        {
          title: "Vaults",
          icon: (
            <Icon icon="icon-park-twotone:filter" className="size-5 shrink-0" />
          ),
          url: "/docs/curate/concepts",
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "Resources",
          icon: (
            <Icon icon="icon-park-twotone:system" className="size-5 shrink-0" />
          ),
          url: "#",
        },
        {
