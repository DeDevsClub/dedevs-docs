...
<Banner id="skool-cta" variant="rainbow">
  <span>
    Join the community on <a className="underline" href="https://skool.com/devs" target="_blank" rel="noreferrer">Skool</a> · Get updates, events, and support.
  </span>
</Banner>
